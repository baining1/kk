...
export InviterPin="iCZD1zKEOzw2Wuf9Zj60MpLcEmEnKD3rC6lAz+4+O4I=" ##你的邀请码
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if (InviterPin.length != 0) {
        ...
        await help2("zjb",Math.random() > 0.5 ? "iCZD1zKEOzw2Wuf9Zj60MpLcEmEnKD3rC6lAz+4+O4I=" : "9irilvenEupYF488TUrl19DLuKQ9zWnXYHf9anC0ujw%3D")        
      }
    }
  }
})()
